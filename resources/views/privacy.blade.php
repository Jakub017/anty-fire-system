...
<div class="privacy">
    <h2 class="privacy__title">Polityka prywatności</h2>

    <h4 class="privacy__heading">§.1 Postanowienia Ogólne</h4>
    <ol class="privacy__list">
        <li class="privacy__text">Administratorem danych jest FPROTECT sp. z o.o. (dawniej ANTYFIRESYSTEM) z siedzibą w
            43-400
        ...
        <li class="privacy__text">Dla interpretacji terminów stosuje się słowniczek Regulaminu lub tak jak zostało to
        ...
        <li class="privacy__text">Dane osobowe podawane w formularzach kontaktowych są traktowane jako poufne i nie są
    ...
    <ol class="privacy__list" start="7">
        ...
        <ul class="privacy__list privacy__list--empty">
            ...
            <li class="privacy__text">c) w zakresie i celu niezbędnym do nawiązania, ukształtowania treści Umowy, zmiany
                bądź jej rozwiązania oraz prawidłowej realizacji Usług świadczonych drogą elektroniczną,</li>
            <li class="privacy__text">d) w zakresie i celu niezbędnym do wypełnienia uzasadnionych interesów (prawnie
                usprawiedliwionych celów), a przetwarzanie nie narusza praw i wolności osoby, której dane dotyczą: w
                zakresie i celu zgodnym ze zgodą wyrażoną przez Ciebie jeśli [przykładowo] zapisałeś się na newsletter,
        ...
        <li class="privacy__text">Każda osoba, której dane dotyczą (jeżeli jesteśmy ich administratorem) ma prawo
            dostępu do danych, sprostowania, usunięcia lub ograniczenia przetwarzania, prawo sprzeciwu, prawo wniesienia
            skargi do organu nadzorczego.
        </li>
        <li class="privacy__text">Kontakt z osobą nadzorującą przetwarzanie danych osobowych w organizacji Usługodawcy
        ...
        <li class="privacy__text">Usługodawca nie udostępniania danych osobowych innym podmiotom aniżeli upoważnionym na
            podstawie właściwych przepisów prawa.
        </li>
        <li class="privacy__text">Usługodawca zapewnia aktualne standardy zabezpieczeń celem zminimalizowania skutków
            ewentualnego naruszenia bezpieczeństwa danych.
        </li>
        <li class="privacy__text">Dane osobowe przetwarzają osoby wyłącznie upoważnione przez nas albo przetwarzający, z
    ...
    <ol class="privacy__list" start="18">
        <li class="privacy__text">Witryna https://fprotect.pl używa plików cookies. Są to niewielkie pliki
            ...
            dotyczą adresu IP, typu wykorzystywanej przeglądarki, języka, rodzaju systemu operacyjnego, dostawcy usług
        ...
        <li class="privacy__text">Zebrane dane służą do monitorowania i sprawdzenia, w jaki sposób użytkownicy
            ...
            bezproblemową nawigację. Monitorowania informacji o użytkownikach dokonujemy korzystając z narzędzia Google
            Analitics, które rejestruje zachowanie użytkownika na stronie.<br>Cookies identyfikuje użytkownika, co
            pozwala na dopasowanie treści witryny, z której korzysta, do jego potrzeb. Zapamiętując jego preferencje,
            umożliwia odpowiednie dopasowanie skierowanych do niego reklam. Stosujemy pliki cookies, aby zagwarantować
            najwyższy standard wygody naszego serwisu, a zebrane dane są wykorzystywane jedynie wewnątrz firmy FPROTECT
        ...
        <ul class="privacy__list privacy__list--empty">
            ...
            <li class="privacy__text">c) „wydajnościowe” pliki cookies, umożliwiające zbieranie informacji o sposobie
        ...
        <li class="privacy__text">Użytkownik w każdej chwili ma możliwość wyłączenia lub przywrócenia opcji gromadzenia
        ...
        <li class="privacy__text">Dodatkowe dane osobowe, jak adres e-mail, zbierane są jedynie w miejscach, w których
            użytkownik wypełniając formularz wyraźnie wyraził na to zgodę. Powyższe dane zachowujemy i wykorzystujemy
